								...
								<aside className="col-lg-5">
									...
									<div className="summary">
										...
										<div className="d-flex mt-3">
											<div className="d-flex align-content-center w-50 mr-3">
												<button
													type="button"
													id="paypal"
													name="options"
													value="paypal"
													className={`paypal-btn ${selectedOption === 'paypal' ? 'active' : ''}`}
													onClick={() => handleRadioChange({ target: { value: 'paypal' } })}
												>
													<img src="https://www.paypalobjects.com/digitalassets/c/website/logo/full-text/pp_fc_hl.svg" alt="PayPal" style={{ height: '24px' }} />
												</button>
											</div>
